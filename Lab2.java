public class Lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = numWives*numKitsPerCat*numCatsPerSack*numSacksPerWife+numWives*numSacksPerWife*numCatsPerSack+numWives*numSacksPerWife+numWives+2;
	} else {
	...
	System.out.println("Number going to St. Ives is "+total);// and then, on the same line,
